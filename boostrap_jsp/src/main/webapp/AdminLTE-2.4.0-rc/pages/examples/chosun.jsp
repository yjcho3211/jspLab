...
#news_wrap h2 a.on {
	...
	<div id="news_wrap">
		...
		<h2>
			<a
				href="https://www.chosun.com/arc/outboundfeeds/rss/category/entertainments/?outputType=xml">엔터테이먼트</a>
		</h2>
		<h2>
			<a
				href="https://www.chosun.com/arc/outboundfeeds/rss/category/sports/?outputType=xml">스포츠</a>
		</h2>
		<h2>
			<a
				href="https://rss.donga.com/science.xml">동아일보(의학과학)</a>
		</h2>
		<ul id="news_list">
		</ul>
	</div>
